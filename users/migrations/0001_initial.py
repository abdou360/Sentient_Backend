# Generated by Django 3.0.7 on 2022-04-17 04:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[(1, 'Superuser'), (2, 'Admin'), (3, 'Teacher'), (4, 'Student')], default=1, max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('apoge_number', models.CharField(max_length=200, unique=True)),
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('admin', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('session_year_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.SessionYearModel')),
            ],
        ),
        migrations.CreateModel(
            name='Admin',
