...
class Module(models.Model):
    ...
    semestre = models.ForeignKey(
        Semestre, null=True, on_delete=models.DO_NOTHING)
...
class ElementModule(models.Model):
    ...
    responsable = models.OneToOneField(
        Professeur, on_delete=models.DO_NOTHING, related_name='%(class)s_responsable', null=True)
...
class Perequis(models.Model):
    id = models.AutoField(primary_key=True)
    element_module_id = models.ForeignKey(
        ElementModule, null=False, blank=False, on_delete=models.CASCADE, related_name='%(class)s_element_module')
    prerequis_id = models.ForeignKey(
        ElementModule, null=False, blank=False, on_delete=models.CASCADE, related_name='%(class)s_prerequis')
